            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('human.store') }}" novalidate
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label>Body</label>
                                            <div class="controls">
                                                <textarea name="body" class="form-control editor" id="basicTextarea" rows="3"    placeholder="Body" style="height: 325px;"></textarea>
                                            </div>
                                        </div>
